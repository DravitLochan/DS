...
/*
flag is a variable to keep track of position of boat
depending on the value of flag, current status of boat, m and c is displayed by display function. it takes 2 char parametrs. These are the 
